...
<body style=" margin:0px;
    ...
    <section id="payment-remainder">
        <div class="payment-remainder-content" style="
            ...
            color: #bf9c60;">Invoice
            </h3>
            <center>
                <table border="0" cellspacing="0" cellpadding="0" width="100%" style="width:50.0%; background:#efefef; border-collapse:collapse">
                    <tbody>
                        <tr>
                            <td width="35%" valign="top" style="width:35.0%; border:solid white 1.0pt; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal">
                                    <b><span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black">Invoice Number</span></b>
                            </td>
                            <td valign="top" style="border:solid white 1.0pt; border-left:none; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal"><span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black">{{$details['body']['invoicenumber']}} </span>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td width="35%" valign="top" style="width:35.0%; border:solid white 1.0pt; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal">
                                    <b><span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black">Booking Id</span></b>
                            </td>
                            <td valign="top" style="border:solid white 1.0pt; border-left:none; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal"><span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black">{{$details['body']['bookingid']}} </span>
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="35%" valign="top" style="width:35.0%; border:solid white 1.0pt; border-top:none; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal"><b><span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black"> Drop Address:</span></b>
                                </p>
                            </td>
                        ...
                        <tr>
                            <td width="35%" valign="top" style="width:35.0%; border:solid white 1.0pt; border-top:none; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal">
                                    <b><span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black">Extra Amount:</span></b>
                                </p>
                            </td>
                            <td valign="top" style="border-top:none; border-left:none; border-bottom:solid white 1.0pt; border-right:solid white 1.0pt; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal">
                                    <span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black">
                                        {{$details['body']['extra Amount']}}
                                    </span>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td width="35%" valign="top" style="width:35.0%; border:solid white 1.0pt; border-top:none; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal">
                                    <b><span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black">Pending Payment:</span></b>
                                </p>
                            </td>
                            <td valign="top" style="border-top:none; border-left:none; border-bottom:solid white 1.0pt; border-right:solid white 1.0pt; padding:3.75pt 3.75pt 3.75pt 3.75pt">
                                <p class="x_MsoNormal">
                                    <span style="font-size:10.0pt; font-family:&quot;Source Sans Pro&quot;,sans-serif; color:black">
                                        {{$details['body']['pendingamount']}}
                                    </span>
                                </p>
                            </td>
                        </tr>
