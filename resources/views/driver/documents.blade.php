                ...
                <div class="col-md-10">
                    <div class="col-md-12">
                        ...
                        <div class="card-header">
                            <form method="post"  action="{{route('driver.store.documents')}}" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="col-md-4">
                                            <div class="bg-light">
                                                <div class="img-responsive">
                                                    ...
                                                    <img data-enlargable  style="cursor: zoom-in; height: 10rem; border-radius: 6px; border: 1px solid gray;" alt="no Image" src="{{asset('uploaded-user-images/partner-documents')}}/{{$document->document_img}}" class="w-100">
                                                </div>
                                                <div class="images">
