...
@section('content')
    ...
    <div class="col-md-9 emp-profile ml-5">
        ...
        $locations = $user->locations;
            ...
            $id = $user->driver->id;
            $user_id = auth()->id();
             $driver = $user->driver; }   else{$id = null;}
        @endphp
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <a href="{{ $id ?  url('driver/update-profile/'.$user_id) : url('driver/profile-view')}}">
                        <input type="button" class="btn btn-dark pull-right" name="btnAddMore" value="Edit Profile"/>
                    </a>
