            ...
            <div class="row">
                    ...
                    <div class="user-account-box">
                        ...
                        <div class="content">
                            <ul>
                                ...
                                <li>
                                    <a href="{{url('/my-rishty')}}" class="active">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 bg-info">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="main-title-2">
                                <h1 style="margin-left:40px;padding-top: 9px;"><span>My</span> RESHTY</h1>
                            </div>

                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div align="center">  <a href="{{url('/add-reshta')}}">
                                    <button class="btn btn-success" style="background:#337ab7; color:white;margin-top:5px;">Add New Rishta</button></a>
                            </div>
                        </div>
                    ...
                    <table class="manage-table responsive-table">
                        ...
                        @if(count($reshty)> 0)
                            @foreach($reshty as $reshta)
                        <tr>
                            <td class="title-container">
                                <div class=" col-lg-4 col-md-5 col-sm-5 col-xs-5">
                                    <img src="{{asset('images/reshta_images')}}/{{count($reshty[2]->reshtaMedia) > 0 ? $reshty[2]->reshtaMedia->first()->image : ''}}" alt="my-properties-5" style="width:100% !important;height:150px;" class="img-responsive img-rounded">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="title">
                                        <h4><a href="#">{{$reshta->first_name}}  {{$reshta->last_name}} </a></h4>
                                        <span><i class="fa fa-map-marker"></i>{{$reshta->city}}  City</span>
                                        <span class="table-property-price"><i class="fas fa-graduation-cap"></i>Age:25</span><br>
                                        <span class="table-property-price"><i class="fas fa-graduation-cap"></i>Coast: {{$reshta->cast}}</span><br>
                                        <span class="table-property-price"><i class="fas fa-graduation-cap"></i>Height: {{$reshta->height}} Feet</span>
                                    </div>


                                </div>
                            </td><td class="expire-date hidden-xs">December 17 2017</td>
                            <td class="action">
                                <a href="{{url('reshta/update/'.$reshta->id)}}"><i class="fa fa-pencil"></i> Edit</a>
                                <a href="{{url('reshta/detail/'.$reshta->id)}}"><i class="fa  fa-eye"></i>Details</a>
