                        ...
                        <div class="login-content">
                            <div id="tab-1" class="content-tab">
                                <div class="login-form">
                                    <form action="{{ route('login') }}" method="post" aria-label="{{ __('Login') }}" accept-charset="utf-8">
                                        @csrf
                                        <div class="one-half">
                                            <div class="form-email">
                                                <label for="">Email</label>
                                                <input id="email" type="email" class="{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus   placeholder="Enter Your Email">
                                                @if ($errors->has('email'))
                                        ...
                                        <div class="one-half">
                                            <div class="form-password">
                                                ...
                                                <input id="password" name="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="************" required>
                                        ...
                                        <div class="one-half">
                                            ...
                                            <div class="btn-submit">
                                                <a href="{{ url('register') }}" title="">Noch kein Konto? Jetzt Registrieren</a>
                                            </div>
                                        </div>
                                        <div class="one-half">
                                            <div class="btn-submit">
                                                <a href="{{ route('password.request') }}" title="">Passwort vergessen</a>
