...
(function($) {
    ...
    // let date = new Date();
    // let time_limit = $('.form_date').attr('data-date');
    // $('#pick-date').change(function () {
    //     let selected_date = $('#dtp_input2').val();
    //         date = new Date(selected_date);
    //       if (date.setHours(0,0,0,0) === new Date().setHours(0,0,0,0)){
    //           let add_hour = new Date().getHours();
    //           add_hour = add_hour + parseInt(time_limit);
    //           date.setHours(add_hour);
    //           initDateTimePicker();
    //       }else {
    //          date = new Date();
