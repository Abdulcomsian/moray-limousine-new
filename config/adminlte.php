...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Vehicle Make',
            'url'  => 'admin/vehicleMake',
            // 'can'  => 'manage-blog',
        ],
        [
            'text' => 'Vehicle Model',
            'url'  => 'admin/vehicleModel',
            // 'can'  => 'manage-blog',
        ],
        [
            'text' => 'Vehicle Category',
            'url'  => 'admin/vehicleCategory',
            // 'can'  => 'manage-blog',
        ],
        [
            'text' => 'Pricing By Distance',
            'url'  => 'admin/pricingByDistance',
            // 'can'  => 'manage-blog',
        ],
        [
            'text' => 'Pricing By Location',
            'url'  => 'admin/pricingByLocation',
            // 'can'  => 'manage-blog',
        ],
        [
            'text' => 'Vehicle Pricing',
            'url'  => 'admin/vehiclePricing',
            // 'can'  => 'manage-blog',
        ],
        // // [
        // //     'text'        => 'pages',
